...
##
<iframe sandbox='allow-scripts allow-same-origin allow-presentation' src='https://www.mentimeter.com/app/presentation/alwudzmhyqruex5vugii3ohbww7ibdix/embed'></iframe>
...
![](images/image2.png){ width=30% .absolute left=30}
![](images/image3.png){ width=43% .absolute right=30}

## Multiplication {.font14}
...
<iframe src="https://www.youtube.com/embed/7RBRKQzOle8" title="HSV Multiplication"></iframe>
https://www.youtube.com/embed/7RBRKQzOle8
...
![](images/image8.png){ width=400px .absolute left=150}
:::
::: {.column width="50%"}
<br>
...
![](images/image9.png){ width=400px .absolute right=50}
:::
::::
...
:::
::: {.column width="30%"}
![](images/image16.png){ width=200px style="display:block; margin:auto;"}
![](images/image15.jpeg){ width=300px style="display:block; margin:auto;"}
:::
::::
...
:::
::: {.column width="40%"}
![](images/image17.jpeg){ width=100% style="display: block; margin-left: auto; margin-right: auto; margin-top:70px; border-radius: 10px;"}
:::
::::
...
:::
::: {.column width="40%"}
![](images/image18.jpeg){ width=100% style="display: block; margin-left: auto; margin-right: auto; margin-top:35px; border-radius: 10px;"}
:::
::::
...
- **Limitations:** needs specialized lab, time-consuming (2–7 days), less sensitive in latent/recurrent infections
...
![](images/image24.png){ width=100% style="display: block; margin-left: auto; margin-right: auto;"}
...
:::{.column width="40%"}
![](images/image25.png){ width=100% style="display:block; margin-left:auto; margin-right:0;" }
