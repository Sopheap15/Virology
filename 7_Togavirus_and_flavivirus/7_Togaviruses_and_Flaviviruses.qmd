---
title: "Togaviruses and Flaviviruses"
...
- List major arbovirus genera (e.g., _Alphavirus_, _Flavivirus_)
...
##
<iframe sandbox='allow-scripts allow-same-origin allow-presentation' src='https://www.mentimeter.com/app/presentation/aluigjmcswmg12od3c8owbud129qj33s/embed'></iframe>
...
:::{.notes}
1. Most likely vector: Aedes species (Aedes aegypti, also A. albopictus) — day‑biting mosquitoes that breed in domestic standing water (containers, tires, flower pots).

2. Vector control (household & community): remove/empty standing water, cover water storage, larviciding in unavoidable sources, use window/door screens, community source‑reduction campaigns, targeted indoor residual spraying or space spraying during outbreaks, promote personal protection (repellents, clothing).

3. Features suggesting progression to DHF/shock: persistent high fever followed by sudden clinical deterioration, severe abdominal pain, persistent vomiting, mucosal bleeding, rapid drop in platelets (<100,000/µL especially <50,000), rising hematocrit (≥20% from baseline) indicating plasma leakage, hypotension/narrow pulse pressure, hepatomegaly, pleural effusion/ascites.

4. Early pathogenesis: virus injected into skin → infects dendritic cells/keratinocytes → local replication → migration to regional lymph nodes → primary viremia and systemic dissemination to reticuloendothelial cells and endothelium. Entry via receptor‑mediated endocytosis, release of (+)ssRNA, translation and replication. In secondary infections antibody‑dependent enhancement can increase viral uptake in Fc‑bearing cells.

5. Diagnostic tests by illness day:
  - Days 0–7: NS1 antigen and RT‑PCR (detect viral antigen/genome early and during viremia).
  - >4–5 days: IgM serology (MAC‑ELISA) becomes positive; IgG rises later.
  - Combined NS1+IgM around days 5–7 maximizes sensitivity.
  - Support labs at presentation and serially: CBC (platelets, hematocrit, WBC), AST/ALT, coagulation profile, electrolytes, renal function.

6. Initial management/outpatient vs admit: outpatient with strict follow‑up if clinically stable, tolerating oral fluids, no warning signs, reliable access to care. Admit if any warning signs, dehydration, persistent vomiting, bleeding, rapid platelet drop or rising hematocrit, hypotension. Essential monitoring: frequent vitals, strict fluid balance, serial CBC (hematocrit and platelets) q4–12h depending on severity, urine output, and timely escalation to IV fluids and supportive care for shock.

7. Why avoid ibuprofen/NSAIDs/aspirin: they impair platelet function and increase bleeding/GI bleeding risk in dengue. Use acetaminophen (paracetamol) for fever/pain.

8. Immediate lab results that change management:
  - Rapidly falling platelets (esp. <100k or precipitous decline) → closer monitoring/admission.
  - Rising hematocrit → indicates plasma leakage → consider IV fluid resuscitation/admit.
  - Positive NS1/RT‑PCR confirms acute infection (infection control/monitoring) but management driven by clinical status and CBC. Abnormal coagulation or significant transaminitis also prompts admission and supportive measures.
:::
...
- _Arboviruses_: spread by arthropod vectors
...
https://www.youtube.com/embed/AKguPkfRuuM
...
https://www.youtube.com/embed/_mo-vJDBm8Y
