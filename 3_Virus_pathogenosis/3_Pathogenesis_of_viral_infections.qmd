...
##
<iframe sandbox='allow-scripts allow-same-origin allow-presentation' src='https://www.mentimeter.com/app/presentation/alemd3a3andpwho19varc928ymp9gnz2/embed'></iframe>


## Group discussion {.font14}

**Analyze these viruses considering the following points:**
*Hepatitis B virus*, *Human papillomavirus* (HPV), *Rotavirus*, *Adenovirus*, *Human immunodeficiency virus* (HIV), *Coronavirus* (SARS-CoV-2)
...
<iframe src="https://www.youtube.com/embed/VURzDTCEovE" title="https://www.youtube.com/embed/VURzDTCEovE"></iframe>
https://www.youtube.com/embed/VURzDTCEovE
...
## Major target organs and systems {.smaller}
...
## Major target organs and systems (cont.){.smaller}
...
![](images/image9.jpg){.absolute top="100px" right="100px" width="300px"}
...
https://www.youtube.com/embed/m-bTWGPZqhk

## Host defenses {.smaller}
...
:::
:::
![](images/innate_adaptive.png){ width="100%" style="display: block; margin-left: auto; margin-right: auto;" }
...
## Herd immunity {.smaller}

- Definition: indirect protection when a sufficient share of the population is immune, reducing transmission
![](images/herdimmunity.png){ width=70% style="display: block; margin-left: auto; margin-right: auto; max-width: none;" }
